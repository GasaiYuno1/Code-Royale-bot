...
PARAMS = {
    "hp": (183, 15, 40, 250, False),
    "ehp": (70, 10, 10, 150, False),
    "tower": (0.36, 0.08, 0.0, 1.0, False),
    "towerbase": (130, 80, 0, 1200, False),
    "towerneed": (1050, 150, 100, 2000, False),
    "towercalm": (720, 100, 0, 1500, False),
    "exposure": (5.8, 1, 0, 12, False),
    "safe": (180, 40, 100, 500, True),
    ...
    "eknight": (7.7, 3, 2, 40, False),
    "nobar": (6100, 1000, 500, 15000, False),
    "econshort": (140, 100, 0, 1500, False),
    "readiness": (1.7, 0.7, 0, 8, False),
    "defneed": (180, 120, 100, 1500, True),
    ...
    "lowhpw": (4.6, 1.5, 0, 15, False),
    "erange": (425, 80, 0, 1000, False),
    "expeta": (0.71, 0.15, 0.0, 1.0, False),
