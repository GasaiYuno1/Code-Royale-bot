...
PARAMS = {
    "hp": (100, 15, 40, 250, False),
    "ehp": (50, 10, 10, 150, False),
    "tower": (0.25, 0.08, 0.0, 1.0, False),
    "towerbase": (400, 80, 0, 1200, False),
    "towerneed": (800, 150, 100, 2000, False),
    "towercalm": (500, 100, 0, 1500, False),
    "exposure": (4, 1, 0, 12, False),
    "safe": (250, 40, 100, 500, True),
    "minefar": (0.4, 0.1, 0.0, 0.9, False),
    "mine": (4, 0.8, 0.5, 10, False),
    "emine": (2, 0.5, 0, 6, False),
    "gold": (4, 1, 0, 10, False),
    "knight": (5, 1.2, 0, 15, False),
    "eknight": (15, 3, 2, 40, False),
    "nobar": (5000, 1000, 500, 15000, False),
    "econshort": (400, 100, 0, 1500, False),
    "readiness": (3, 0.7, 0, 8, False),
    "defneed": (600, 120, 100, 1500, True),
    "giantbar": (1500, 300, 0, 5000, False),
    "cover": (300, 80, 0, 1000, False),
    "lead": (5000, 1000, 0, 15000, False),
    "lowhpw": (5, 1.5, 0, 15, False),
    "erange": (300, 80, 0, 1000, False),
    "expeta": (0.5, 0.15, 0.0, 1.0, False),
    "persist": (150, 40, 0, 500, False),
}
