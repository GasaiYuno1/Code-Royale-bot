#!/usr/bin/env python3
"""Склеивает все .cs из src/RoyaleBot в один файл для вставки в IDE CodinGame.

Правила, на которые опирается склейка:
  * каждый файл использует блочный `namespace Royale { ... }` (не file-scoped);
